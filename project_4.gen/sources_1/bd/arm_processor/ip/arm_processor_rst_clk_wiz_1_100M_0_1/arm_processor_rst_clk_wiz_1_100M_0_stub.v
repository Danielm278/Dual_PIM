...
// Command     : write_verilog -force -mode synth_stub -rename_top arm_processor_rst_clk_wiz_1_100M_0 -prefix
//               arm_processor_rst_clk_wiz_1_100M_0_ arm_processor_rst_clk_wiz_1_100M_0_stub.v
...
/* synthesis syn_force_seq_prim="slowest_sync_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 clock CLK" *) (* x_interface_mode = "slave clock" *) (* x_interface_parameter = "XIL_INTERFACENAME clock, ASSOCIATED_RESET mb_reset:bus_struct_reset:interconnect_aresetn:peripheral_aresetn:peripheral_reset, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN arm_processor_clk_wiz_1_0_clk_out1, INSERT_VIP 0" *) input slowest_sync_clk /* synthesis syn_isclock = 1 */;

...
//               c:/project_4/project_4.gen/sources_1/bd/arm_processor/ip/arm_processor_util_ff_1_0/arm_processor_util_ff_1_0_stub.v
...
(* CHECK_LICENSE_TYPE = "arm_processor_util_ff_1_0,util_ff_v1_0_4_util_ff,{}" *) (* CORE_GENERATION_INFO = "arm_processor_util_ff_1_0,util_ff_v1_0_4_util_ff,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=util_ff,x_ipVersion=1.0,x_ipCoreRevision=4,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_WIDTH=32,C_FF_TYPE=1,C_INIT=0x00000000,C_C_INVERTED=0,C_R_INVERTED=1,C_G_INVERTED=0,C_S_INVERTED=0,C_CLR_INVERTED=0,C_PRE_INVERTED=0,C_D_INVERTED=0,C_FF_LEVELS=1}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "util_ff_v1_0_4_util_ff,Vivado 2024.2" *) 
module arm_processor_util_ff_1_0(clk, D, Q, reset, clk_enable)
/* synthesis syn_black_box black_box_pad_pin="D[31:0],Q[31:0],reset,clk_enable" */

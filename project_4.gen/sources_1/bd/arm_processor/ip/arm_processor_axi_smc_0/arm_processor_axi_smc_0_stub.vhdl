...
-- Command     : write_vhdl -force -mode synth_stub -rename_top arm_processor_axi_smc_0 -prefix
--               arm_processor_axi_smc_0_ arm_processor_axi_smc_0_stub.vhdl
...
entity arm_processor_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of arm_processor_axi_smc_0 : entity is "arm_processor_axi_smc_0,bd_1ae3,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of arm_processor_axi_smc_0 : entity is "arm_processor_axi_smc_0,bd_1ae3,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of arm_processor_axi_smc_0 : entity is "yes";
end arm_processor_axi_smc_0;

architecture stub of arm_processor_axi_smc_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN arm_processor_clk_wiz_1_0_clk_out1, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_1ae3,Vivado 2024.2";
begin
end;

...
HD_PWD='C:/project_4/project_4.runs/arm_processor_util_ff_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_processor_util_ff_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arm_processor_util_ff_0_0.tcl
